...
public:
     ...
     */
    explicit Controller(RepoAbs& repository, Validator& val): repository{repository}, val{val}{};
    ...
    int filterType(size_t counter, int pos[100], string type);
...
private:
    ...
    vector<unique_ptr<UndoAction>> undoActionList;
};
