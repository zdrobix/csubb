...
export class AppService {
  ...
  getAllGameConfigs() : Observable<GameConfig[]> {
    return this.http.get<GameConfig[]>(`${environment.apiBaseUrl}/api/gameconfig/all`);
  }

  updateGameConfig(request: AddGameConfigRequest, id: number) {
     return this.http.put<GameConfig>(`${environment.apiBaseUrl}/api/gameconfig/${id}`, request)
  }
