...
static const yytype_int8 yyrhs[] =
{
      ...
      20,    -1,    22,    -1,    23,    -1,    24,    -1,     5,    21,
      14,    -1,     3,    -1,    21,    15,     3,    -1,     6,    12,
       3,    13,    14,    -1,     7,    12,     3,    13,    14,    -1,
       3,     8,    25,    14,    -1,    26,    -1,    25,     9,    26,
      -1,    25,    10,    26,    -1,    27,    -1,    26,    11,    27,
      -1,     3,    -1,     4,    -1,    12,    25,    13,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,    52,    52,    56,    57,    61,    62,    63,    64,    68,
      72,    78,    87,    96,   105,   115,   118,   131,   147,   150,
     166,   172,   177
};
#endif
...
{
  "$end", "error", "$undefined", "ID", "NUM", "INT", "READ", "WRITE",
  "ASSIGN", "PLUS", "MINUS", "MULT", "LPAREN", "RPAREN", "SEMI", "COMMA",
  "$accept", "program", "statements", "statement", "declaration",
  "id_list", "read_stmt", "write_stmt", "assign_stmt", "expr", "term",
  "factor", 0
};
#endif
...
{
       0,     0,     0,     0,     0,     0,     2,     3,     5,     6,
       7,     8,     0,    10,     0,     0,     0,     1,     4,    20,
      21,     0,     0,    15,    18,     9,     0,     0,     0,     0,
       0,     0,    14,     0,    11,     0,     0,    22,    16,    17,
      19,    12,    13
};
...
{
       5,    -2,    15,     7,     8,    21,     5,   -16,   -16,   -16,
     -16,   -16,    -3,   -16,   -10,    19,    20,   -16,   -16,   -16,
     -16,    -3,    -7,    13,   -16,   -16,    22,    14,    16,     4,
      -3,    -3,   -16,    -3,   -16,    12,    17,   -16,    13,    13,
     -16,   -16,   -16
};
...
{
      19,    20,    30,    31,    25,    26,    12,    32,     1,    21,
       2,     3,     4,    30,    31,    38,    39,    37,    13,    15,
      16,    17,    27,    28,    33,    34,    41,    35,    40,    36,
      18,    42,    29
};

static const yytype_uint8 yycheck[] =
{
       3,     4,     9,    10,    14,    15,     8,    14,     3,    12,
       5,     6,     7,     9,    10,    30,    31,    13,     3,    12,
      12,     0,     3,     3,    11,     3,    14,    13,    33,    13,
       6,    14,    21
};
...
{
       0,     3,     5,     6,     7,    17,    18,    19,    20,    22,
      23,    24,     8,     3,    21,    12,    12,     0,    19,     3,
       4,    12,    25,    26,    27,    14,    15,     3,     3,    25,
       9,    10,    14,    11,     3,    13,    13,    13,    26,    26,
      27,    14,    14
};
...
#line 166 ".\\parser.y"
    {
        char* result = malloc(strlen((yyvsp[(1) - (1)].str)) + 3);
        sprintf(result, "[%s]", (yyvsp[(1) - (1)].str));
        free((yyvsp[(1) - (1)].str));
        (yyval.str) = result;
    ;}
    break;
...
#line 172 ".\\parser.y"
    {
        char* result = malloc(20);
        sprintf(result, "%d", (yyvsp[(1) - (1)].num));
        (yyval.str) = result;
    ;}
    break;
